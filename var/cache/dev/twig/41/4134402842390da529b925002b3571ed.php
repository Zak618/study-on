...
class __TwigTemplate_10840eaac03b807a0f5ad24f342d8793 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1 style=\"margin-left: 20px;\">Редактировать: ";
    ...
    <a href=\"";
        ...
        echo "\" style=\"margin-left: 20px; margin-top: 20px;\"><button type=\"button\" class=\"btn btn-outline-secondary\">Назад к курсу</button></a>
...
";
    ...
    {
        return array (  108 => 15,  103 => 13,  96 => 9,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Редактировать: {{ course.name }}{% endblock %}

{% block body %}
    <h1 style=\"margin-left: 20px;\">Редактировать: {{ course.name }}</h1>
    ...
    <a href=\"{{ path('app_course_index') }}\" style=\"margin-left: 20px; margin-top: 20px;\"><button type=\"button\" class=\"btn btn-outline-secondary\">Назад к курсу</button></a>

    {{ include('course/_delete_form.html.twig') }}
{% endblock %}
", "course/edit.html.twig", "/app/templates/course/edit.html.twig");
    }
}

...
class __TwigTemplate_7e440c90fa8acdbe8bb71e10218baaca extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 8
        echo twig_include($this->env, $context, "course/_form.html.twig", ["button_label" => "Сохранить"]);
        echo "

    <a href=\"";
        // line 10
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_course_index");
        echo "\">Назад к списку</a>
...
{% block body %}
    ...
    {{ include('course/_form.html.twig', {'button_label': 'Сохранить'}) }}

    <a href=\"{{ path('app_course_index') }}\">Назад к списку</a>

    {{ include('course/_delete_form.html.twig') }}
{% endblock %}
", "course/edit.html.twig", "/Users/rolanzakirov/Desktop/work/study-on/templates/course/edit.html.twig");
    }
}
